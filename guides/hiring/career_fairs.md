# Scope Web guide to career fairs
...
At the start we weren't sure on how to begin conversations but throughout the day we built up a fairly consistent conversation structure that worked for us:
 ...
 - Also invite people to our Microsoft Teams recruitment group, to code dojos or whatever else if you fancy.
 
## Things to try next time

 - Name badges with Scope Web logo on them
