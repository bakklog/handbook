...
Our pipeline is tracked in a [SharePoint Document](https://scopeweb.sharepoint.com/sites/team).

### Define a need and expectation for hiring

As described in our [Roles at Scope Web](/roles/README.md) document, candidates must be judged against a specific role with the needs and expectations of that role explicitly defined. This allows us to judge candidates like for like and also keeps us focused on the reason for a hire.
...
Our current Engineer pairing task can be found in this [SharePoint document](https://scopeweb.sharepoint.com/:w:/s/team/EcSt3e5o65lIjixrk8_X3vEBxq4zw8YiTxu9BrQ766ABnw?e=4CSq5j). (Sorry if you're a candidate looking at this, we do not hand out these questions in advance.)

#### Problem solving

We follow up with some more technical, deeper thinking questions documented in this [SharePoint document](https://scopeweb.sharepoint.com/:w:/s/team/EU5zPWUyYx9KvLG06P-VbvYBS_BrYAyDQUalaDyxQzlg3Q?e=w7IR8W). (Sorry if you're a candidate looking at this, we do not hand out these questions in advance.)
